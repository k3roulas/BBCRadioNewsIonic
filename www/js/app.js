...
var app = angular.module('BBCRadioNews', ['ionic', 'ngAudio', 'xml']);
...
app.controller('HomeCtrl',  function($scope, ngAudio, $http, $q, x2js) {
...
//    }
    ...
    $q.all(promises).then(function() {
        ...
        $scope.newsList= $scope.newsList.sort(function(a,b) {
...
//    }
    ...
    $scope.isDisplayPlayer = function() {
        return $scope.playerStatus == 'play' || $scope.playerStatus == 'pause';
    }
